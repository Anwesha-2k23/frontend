...
const bhopalReg = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (eventname == null) {
            ...
            toast.warning(
                'Fill all the fields of 2nd member also to register',
                {
                    position: 'top-right',
                    autoClose: 3000,
                    hideProgressBar: false,
            ...
            toast.warning(
                'Fill all the fields of all the members to register',
                {
                    position: 'top-right',
                    autoClose: 3000,
                    hideProgressBar: false,
            ...
            let body = {
                ...
                leader_phone_no: leaderphone,
                leader_organisation: leaderorg,
                member_one_name: member1name,
                member_one_email: member1email,
                member_one_phone_no: member1phone,
                member_one_organisation: member1org,
                member_two_name: member2name,
                member_two_email: member2email,
                member_two_phone_no: member2phone,
                member_two_organisation: member2org,
                member_three_name: member3name,
                member_three_email: member3email,
                member_three_phone_no: member3phone,
                member_three_organisation: member3org,
            }
            // console.log(body);
            try {
                const response = await fetch(
                    `https://${host}/multicity/register`,
                    {
                        method: 'POST',
                        headers: {
                    ...
                    >
                        ...
                        >
                            ...
                            <div className={styles.form_row}>
                                ...
                                <div className={styles.field}>
                                    <label htmlFor="Leader_Phone_number">
                            ...
                            <div className={styles.form_row}>
                                ...
                                <div className={styles.field}>
                                    <label htmlFor="Leader_Organization">
                        ...
                        {eventname == 'evb6' ? (
                            ...
                            >
                                ...
                                <div className={styles.form_row}>
                                    ...
                                    <div className={styles.field}>
                                        <label htmlFor="Member_1_Phone_number">
                                        ...
                                        <input
                                            ...
                                            maxLength="10"
                                            onChange={(e) =>
                                                setMember1Phone(e.target.value)
                                            }
                                        />
                                        <br />
                                    </div>
                                ...
                                <div className={styles.form_row}>
                                    ...
                                    <div className={styles.field}>
                                        <label htmlFor="Member_1_Organization">
                        ...
                        {eventname == 'ev6a' || eventname == 'ev5b' ? (
                            <div>
                                ...
                                >
                                    <h2 className={styles.subHeading}>
                                        1st Team Member's Details
                                    </h2>
                                    <div className={styles.form_row}>
                                        <div className={styles.field}>
                                            <label htmlFor="Member_1_Name">
                                                1<sup>st</sup> Team Member's
                                                Name
                                            </label>
                                            <br />
                                            <input
                                ...
                                >
                                    <h2 className={styles.subHeading}>
                                        2nd Team Member's Details
                                    </h2>
                                    <div className={styles.form_row}>
                                        <div className={styles.field}>
                                            <label htmlFor="Member_2_Name">
                                                2<sup>nd</sup> Team Member's
                                                Name
                                            </label>
                                            <br />
                                            <input
                                        ...
                                        <div className={styles.field}>
                                            <label htmlFor="Member_2_Phone_number">
                                                2<sup>nd</sup> Team Member's
                                                Phone Number
                                            </label>
                                            <br />
                                    ...
                                    <div className={styles.form_row}>
                                        ...
                                        <div className={styles.field}>
                                            <label htmlFor="Member_2_Organization">
                                                2<sup>nd</sup> Team Member's
                                                Organization
                                            </label>
                                            <br />
                                ...
                                >
                                    <h3 className={styles.subHeading}>
                                        3rd Team Member's Details
                                    </h3>
                                    <div className={styles.form_row}>
                                        <div className={styles.field}>
                                            <label htmlFor="Member_3_Name">
                                                3<sup>rd</sup> Team Member's
                                                Name
                                            </label>
                                            <br />
                                            <input
                                        ...
                                        <div className={styles.field}>
                                            <label htmlFor="Member_3_Phone_number">
                                                3<sup>rd</sup> Team Member's
                                                Phone Number
                                            </label>
                                            <br />
                                    ...
                                    <div className={styles.form_row}>
                                        ...
                                        <div className={styles.field}>
                                            <label htmlFor="Member_3_Organization">
                                                3<sup>rd</sup> Team Member's
                                                Organization
                                            </label>
                                            <br />
