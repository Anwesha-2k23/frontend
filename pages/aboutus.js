        ...
        <div className={styles.parentContainer}>
            <section className={styles.section1}>
                <div className={styles.container}>
                    ...
                    <div className={styles.sectionContent}>
                        ...
                        <br /><br />
                        We invite you to be a part of this extravaganza and help us make it bigger and better by sponsoring it. We hope that our synergy will usher into a relationship for both of us. a novel and longstanding.
                        <br /><br />
            ...
            <section className={styles.section1}>
                <div className={styles.container}>
                    ...
                    <hr className={styles.sectionHeadingBar} />
                    <div className={styles.sectionContent}>
                        <strong>EXPANDING THE CULTURAL LANDSCAPE & NURTURING INDEPENDENT TALENT</strong>
                        <br />
                        &#x2022; With the expanding music palette of Indian audiences after the internet arrived, Anwesha 2023 is at the converging point to introduce independent music and art at college festivals.
                        <br />
                    ...
                    <div className={styles.sectionContent}>
                        ...
                        <br />
                        &#x2022; As a major festival with massive footfall, we are aware of the enormous resource consumption and consequent waste generated throughout this festival. Anwesha’23 shall focus on bringing a sustainable lifestyle & culture to the mainstream.
                        <br />
                    ...
                    <div className={styles.sectionContent}>
                        ...
                        <br />
                        &#x2022; The folk culture in Bihar is immense - from Madhubani to Yampuri, Jat-Jatin to bamboo & pottery craft; we would be delighted to accommodate it all in Anwesha 2k23.
                    </div>
                    <div className={styles.sectionContent}>
