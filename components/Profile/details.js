...
function Details() {
    ...
    function editProfile() {
        ...
        var raw = JSON.stringify({full_name: formData.full_name, gender: formData.gender, college_name: formData.college_name});
    ...
    return(
      <div className={styles.container}>
        {edit ? null : <img src='/assets/edit.svg' onClick={() => {setEdit(true)}}/>}
        ...
        {edit ? <div className={styles.button_row}>
        <button onClick={() => {setFormData(profDetails); setEdit(false)}}>CANCEL</button>
        <button onClick={() => {editProfile(); setEdit(false)}}>SUBMIT</button>
        </div> : null}
      </div>
    )
  }
