...
function Razor() {
	...
	async function displayRazorpay() {
		...
		myHeaders.append("Cookie", "jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IkFOVzgxYmYwY2IiLCJleHAiOjE2Nzc0MDgzMDMsImlhdCI6MTY3NzQwNDcwM30.U-kRCbCOaN_TftjlzsiLF8_RTv3A8bGccw2nkfe69zA");
		...
		const data = await fetch("http://localhost:8000/event/registration/solo", requestOptions)
