        ...
        <div className={styles.footer}>
            <div className={[styles.mainSection].join(' ')}>
                <div className={[styles.section3].join(' ')}>
                    <div className={styles.footerTable}>
                        ...
                        <div className={styles.footerTableRow}>
                            <Link className={styles.footerLink} href = "/"><div className={styles.footerTableCell}>Home</div></Link>
                            <Link className={styles.footerLink} href = "/events"><div className={styles.footerTableCell}>Events</div></Link>
                            <Link className={styles.footerLink} href = "/sponsors"><div className={styles.footerTableCell}>Sponsors</div></Link>
                        </div>
                        <div className={styles.footerTableRow}>
                            <Link className={styles.footerLink} href = "/profile"><div className={styles.footerTableCell}>Profile</div></Link>
                            <Link className={styles.footerLink} href = "/about"><div className={styles.footerTableCell}>About Us</div></Link>
                            <Link className={styles.footerLink} href = "/team"><div className={styles.footerTableCell}>Team</div></Link>
                        </div>
                ...
                <div className={styles.middle_container}>
                    ...
                    <span className={styles.newsletter}>Subscribe to our Mailing list</span>
                    <form className={styles.form} name="submit-to-google-sheet">
                    <input placeholder='ram@gmail.com' onChange={handleChange} value={email} type="email" name="mailing" id="email" className={styles.mailInput}/>
                    {/* <button
                ...
                <div className={[styles.section1].join(' ')}>
                  ...
                  >
                      <a href="#">
                          ...
                          /> */}
                          <Image alt='google play icon' src={'/footer/googlePlay.svg'} width={250} height={250}></Image>
                      </a>
                  </div>
                    {/* </a> */}
                </div>
